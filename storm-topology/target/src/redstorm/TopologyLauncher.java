...
public class TopologyLauncher extends RubyObject  {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "end\n" +
            "").toString();
        __ruby__.executeScript(source, "/home/ubuntu/.rvm/gems/jruby-1.7.11/gems/redstorm-0.7.0.beta1/lib/red_storm/topology_launcher.rb");
    ...
    public static void main(String[] args) {
        ...
        IRubyObject ruby_result = Helpers.invoke(__ruby__.getCurrentContext(), __metaclass__, "main", ruby_arg_args);
        return;
    ...
    public static Object camel_case(Object s) {
        IRubyObject ruby_arg_s = JavaUtil.convertJavaToRuby(__ruby__, s);
        IRubyObject ruby_result = Helpers.invoke(__ruby__.getCurrentContext(), __metaclass__, "camel_case", ruby_arg_s);
